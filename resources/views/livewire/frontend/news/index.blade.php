<div>
    ...
    <section class="relative pt-32 pb-24 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-white/90 max-w-2xl mx-auto">Dapatkan berita dan artikel terbaru seputar BPRS Bangka Belitung dan dunia perbankan syariah</p>
        </div>
    </section>
    ...
    <section class="py-12 -mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="flex-1">
                        <div class="relative">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari berita berdasarkan judul..." class="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                    </div>
                    <div class="w-full md:w-48">
                        <select wire:model.live="category" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white">
            ...
            <div wire:loading.remove class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <article class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-emerald-200" wire:key="news-{{ $item->id }}">
                    <!-- Image -->
                    <div class="relative h-56 overflow-hidden">
                        ...
                        <!-- Category Badge -->
                        @if($item->category)
                        <span class="absolute top-4 left-4 px-3 py-1.5 bg-emerald-500 text-white text-xs font-bold rounded-lg shadow-lg">{{ $item->category }}</span>
                        @endif
                    </div>
                    ...
                    <div class="p-5">
                        ...
                        <!-- Read More -->
                        <a href="{{ route('news.show', $item->slug) }}" class="inline-flex items-center gap-2 text-emerald-600 font-semibold text-sm group/link hover:text-emerald-700">
                            Baca Selengkapnya
