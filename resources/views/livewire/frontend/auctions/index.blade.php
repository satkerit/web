<div>
    ...
    <section class="relative pt-32 pb-28 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Informasi <span class="text-teal-200">Lelang</span>
            </h1>
    ...
    <section class="py-12 -mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col lg:flex-row gap-4">
                    <div class="flex-1">
                        <div class="relative">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari berdasarkan judul atau lokasi..." class="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-gray-900 placeholder-gray-400">
                        </div>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <select wire:model.live="statusFilter" class="px-5 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white text-gray-700 min-w-[160px]">
                        ...
                        <select wire:model.live="assetType" class="px-5 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white text-gray-700 min-w-[160px]">
            ...
            <div wire:loading.remove class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-emerald-200 hover:-translate-y-1" wire:key="auction-{{ $auction->id }}">
                    <!-- Image Container -->
                    <div class="relative h-64 overflow-hidden">
                        ...
                        @else
                            <div class="w-full h-full bg-gradient-to-br from-emerald-400 via-teal-400 to-emerald-500 flex items-center justify-center">
                        ...
                        <div class="absolute top-4 left-4 z-10">
                            ...
                            @elseif($auction->status === 'sold')
                                <span class="inline-flex items-center gap-1.5 px-4 py-2 bg-emerald-500 text-white text-sm font-bold rounded-xl shadow-lg">
                        ...
                        @if($auction->status === 'sold')
                            <div class="absolute inset-0 bg-emerald-900/70 flex items-center justify-center z-20">
                                <div class="text-center transform -rotate-12">
                                    <div class="inline-block border-4 border-white px-8 py-4 rounded-lg">
                                        ...
                                        @if($auction->winning_bid)
                                            <p class="text-emerald-200 text-sm mt-1">Rp {{ number_format($auction->winning_bid, 0, ',', '.') }}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="p-6">
                        <!-- Title -->
                        <h3 class="text-lg font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-emerald-600 transition-colors min-h-[56px]">
                            {{ $auction->title }}
                        </h3>
                ...
                <div class="col-span-full">
                    <div class="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-lg">
                        ...
                        <button wire:click="$set('search', ''); $set('statusFilter', ''); $set('assetType', '')" class="inline-flex items-center gap-2 px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold rounded-xl transition-colors">
    ...
    <section class="py-16 bg-gradient-to-r from-emerald-600 to-teal-600">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-white text-emerald-600 font-bold rounded-xl hover:bg-emerald-50 transition-colors shadow-lg">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
