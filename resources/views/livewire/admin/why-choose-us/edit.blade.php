<div>
    <x-admin.page-header title="Edit Why Choose Us" subtitle="Edit item Why Choose Us">
        <x-slot:actions>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <x-admin.card title="Icon" subtitle="Upload icon untuk item">
                    <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                    <div class="flex items-center gap-4">
                                        <img src="{{ $this->getImageUrl($current_icon) }}" alt="Current icon" class="w-16 h-16 rounded-lg object-cover">
                                        <div>
                                            <p class="text-sm font-medium text-gray-900">Icon tersimpan</p>
                                            <button type="button"
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                {{ $current_icon ? 'Ganti Icon' : 'Upload Icon' }}
                            </label>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex items-center gap-3">
                                @if($current_icon)
                                    <img src="{{ $this->getImageUrl($current_icon) }}" alt="Icon" class="w-12 h-12 rounded-lg object-cover">
                                @else
                ...
                <x-admin.card :noPadding="true">
                    <div class="p-5 space-y-3">
                        <button type="submit" 
                            ...
                            <span wire:loading.remove wire:target="save">Update Item</span>
                        </button>
