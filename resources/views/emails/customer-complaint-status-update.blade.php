...
<head>
    <meta charset="utf-8">
    <title>Update Status Pengaduan Nasabah</title>
    <style>
        body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background: #f3f4f6; }
        .wrapper { padding: 20px; }
        .container { max-width: 600px; margin: 0 auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
        .header { background: linear-gradient(135deg, #0d9488, #10b981); color: white; padding: 30px; text-align: center; }
        ...
        .resolution-box { background: #ecfdf5; border: 1px solid #6ee7b7; border-radius: 8px; padding: 20px; margin: 20px 0; }
        .resolution-box h3 { margin: 0 0 10px 0; color: #047857; font-size: 14px; }
        .resolution-box p { margin: 0; color: #065f46; }
        ...
        .company-name { font-weight: bold; color: #0d9488; }
    </style>
</head>
<body>
    <div class="wrapper">
        <div class="container">
            <div class="header">
                ...
                <p>Ada perubahan status pada pengaduan Anda</p>
            ...
            <div class="content">
                ...
                <div class="resolution-box">
                    <h3>✅ Resolusi Pengaduan</h3>
                    <p>{!! nl2br(e($resolution)) !!}</p>
                </div>
                @endif
                ...
                <div class="info-box">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">{{ $complaint->category_label }}</span>
                    </div>
                    <div class="info-row">
                ...
                <p class="message">
                    Pengaduan Anda telah selesai ditangani. Terima kasih atas masukan Anda. Kepuasan nasabah adalah prioritas utama kami.
                </p>
                @else
                <p class="message">
                    Tim kami sedang menindaklanjuti pengaduan Anda. Anda akan menerima notifikasi email jika ada perkembangan lebih lanjut.
                </p>
                @endif
            </div>
