                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-6 sticky top-24">
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-100 space-y-3">
                            ...
                            <a href="{{ $office->directions_url }}"
                               target="_blank"
                               class="flex items-center justify-center w-full px-4 py-3 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition shadow-lg shadow-emerald-600/20 transform hover:-translate-y-0.5">
                            ...
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $office->phone) }}"
                               target="_blank"
                               class="flex items-center justify-center w-full px-4 py-3 bg-white border-2 border-emerald-600 text-emerald-600 rounded-xl font-bold hover:bg-emerald-50 transition">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981zm11.387-5.466c-.74-.37-4.313-2.13-4.871-2.371-.558-.24-1.286-.35-1.784.569-.499.92-1.636 2.026-1.935 2.405-.297.387-.767.576-1.523.235-3.34-1.503-5.438-4.411-5.787-5.018-.348-.607-.05-1.123.33-1.495.29-.285.586-.59.883-.885.297-.296.402-.503.602-.902.2-.4.105-.75-.05-.998-.155-.248-1.285-3.174-1.892-4.21-.497-.846-1.09-1.037-1.523-1.037-.403 0-.853.018-1.306.023-.453.005-1.137.183-1.639.73-.502.547-1.89 1.842-1.89 4.49 0 2.649 1.932 5.211 2.203 5.576.27.365 3.997 5.922 9.471 8.281 3.257 1.404 4.545 1.498 6.138 1.258 1.593-.239 4.313-1.756 4.912-3.451.6-1.697.6-3.151.423-3.451-.177-.299-.661-.477-1.401-.847z"/>
                                </svg>
                                WhatsApp
                            </a>
                        </div>
