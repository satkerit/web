<x-frontend-layout>
    ...
    <section class="relative py-20 md:py-24 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">Struktur Organisasi</h1>
            <p class="text-xl text-emerald-50 max-w-2xl mx-auto">Struktur organisasi {{ $companyInfo?->name ?? 'BPRS Bangka Belitung' }}</p>
        </div>
    </section>
