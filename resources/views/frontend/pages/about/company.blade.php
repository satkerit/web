<x-frontend-layout>
    ...
    <section class="relative pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 animate-slide-up delay-100 tracking-tight px-4">Profil Perusahaan</h1>
            <p class="text-base sm:text-lg md:text-xl text-white/80 max-w-2xl mx-auto animate-slide-up delay-200 px-4">Mengenal lebih dekat BPRS Bangka Belitung, bank perekonomian rakyat berbasis syariah yang terpercaya</p>
        </div>
    </section>
    ...
    <section class="py-12 sm:py-16 md:py-20 -mt-8 sm:-mt-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden border border-gray-100">
                <div class="grid lg:grid-cols-2">
                    <div class="p-6 sm:p-8 lg:p-12" x-intersect="$el.classList.add('animate-slide-in-left')">
                        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">{{ $companyInfo->name ?? 'BPRS Bangka Belitung' }}</h2>
                        <div class="prose prose-sm sm:prose-base lg:prose-lg prose-emerald max-w-none text-gray-600">
                        ...
                        <div class="mt-6 sm:mt-8 flex items-center">
                            <div class="w-12 h-12 sm:w-14 sm:h-14 bg-primary-100 rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                            ...
                            <div>
                                <p class="text-xs sm:text-sm text-gray-500">Berdiri Sejak</p>
                                <p class="text-xl sm:text-2xl font-bold text-gray-900">{{ $companyInfo->established_year }}</p>
                            </div>
                        </div>
                        @endif
                    </div>
                    <div class="relative h-64 sm:h-80 lg:h-auto" x-intersect="$el.classList.add('animate-slide-in-right')">
    ...
    <!-- Vision & Mission -->
    <section class="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-gray-50 to-primary-50/30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid sm:grid-cols-2 gap-6 sm:gap-8">
                <!-- Vision -->
                <div class="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl shadow-gray-200/50 card-hover border border-gray-100" x-intersect="$el.classList.add('animate-scale-in')">
                    <div class="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg shadow-primary-500/30">
                        <svg class="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                    </div>
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Visi</h3>
                ...
                <!-- Mission -->
                <div class="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl shadow-gray-200/50 card-hover border border-gray-100" x-intersect="$el.classList.add('animate-scale-in')" style="animation-delay: 100ms">
                    <div class="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg shadow-blue-500/30">
    ...
    <section class="py-12 sm:py-16 md:py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12" x-intersect="$el.classList.add('animate-slide-up')">
                <span class="inline-block px-3 sm:px-4 py-1.5 sm:py-2 bg-amber-100 text-amber-700 rounded-full text-xs sm:text-sm font-semibold mb-3 sm:mb-4">Sejarah</span>
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Perjalanan Kami</h2>
            </div>
            <div class="bg-gradient-to-br from-gray-50 to-primary-50/30 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12" x-intersect="$el.classList.add('animate-scale-in')">
                <div class="prose prose-sm sm:prose-base lg:prose-lg prose-primary max-w-none text-gray-600" style="text-align: justify;">
