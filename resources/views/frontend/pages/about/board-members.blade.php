    ...
    <section class="py-16 md:py-24 bg-gray-50/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center gap-8">
                ...
                <div class="group relative flex flex-col bg-white rounded-[2rem] shadow-sm border border-gray-100/80 overflow-hidden hover:shadow-xl hover:shadow-teal-900/5 hover:-translate-y-1.5 transition-all duration-500 ease-out w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.5rem)] xl:w-[calc(25%-1.5rem)] max-w-sm"
                     x-data="{ loaded: false }">
                    ...
                    <div class="relative aspect-[4/5] overflow-hidden bg-gray-100">
                        ...
                        <div class="w-full h-full bg-gradient-to-br from-teal-50 to-emerald-50 flex items-center justify-center" x-init="loaded = true">
                            <div class="text-center p-6">
                                <div class="w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-3 text-teal-600">
                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                    </svg>
                                </div>
                                <span class="text-xs font-medium text-teal-600 uppercase tracking-widest">No Photo</span>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out">
                            <div class="flex items-center gap-2 text-white/90 text-xs font-medium uppercase tracking-widest mb-2">
                                <span class="w-8 h-px bg-teal-400"></span>
                                Profile Details
                            </div>
                    ...
                    <div class="p-6 text-center">
                        <div class="mb-4">
                            <h3 class="text-lg font-bold text-gray-900 group-hover:text-teal-600 transition-colors duration-300 leading-snug mb-1">
                                {{ $member->name }}
                            </h3>
                            <div class="inline-flex items-center px-3 py-1 bg-teal-50 rounded-full text-teal-700 text-xs font-bold uppercase tracking-wider">
                                {{ $member->position }}
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            class="inline-flex items-center justify-center w-full px-5 py-2.5 bg-gray-900 text-white text-sm font-bold rounded-xl hover:bg-teal-600 hover:shadow-lg hover:shadow-teal-600/20 active:scale-95 transition-all duration-300"
                        >
