<x-frontend-layout>
    ...
    <section class="relative pt-32 pb-20 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-6 animate-slide-up delay-100 tracking-tight">Whistleblowing System</h1>
            <p class="text-xl text-white/80 max-w-2xl mx-auto animate-slide-up delay-200">Laporkan dugaan pelanggaran dengan aman dan terjamin kerahasiaannya</p>
        </div>
    </section>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-xl shadow-gray-200/50 border border-gray-100" x-intersect="$el.classList.add('animate-slide-in-left')" style="animation-delay: 100ms">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-600 text-sm">Kecurangan (Fraud)</span>
                            </li>
                            <li class="flex items-start">
                                <span class="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
                                    <svg class="w-3 h-3 text-red-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                </span>
                                <span class="text-gray-600 text-sm">Pelanggaran Peraturan</span>
                            </li>
                            <li class="flex items-start">
                                <span class="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
                                    <svg class="w-3 h-3 text-red-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                </span>
                                <span class="text-gray-600 text-sm">Pelanggaran Kode Etik</span>
                            </li>
                            <li class="flex items-start">
                                <span class="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
                                    <svg class="w-3 h-3 text-red-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                </span>
                                <span class="text-gray-600 text-sm">Penyalahgunaan Wewenang</span>
                            </li>
                            <li class="flex items-start">
                                <span class="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
                                    <svg class="w-3 h-3 text-red-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                </span>
                                <span class="text-gray-600 text-sm">Keselamatan Kerja</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="lg:col-span-2" x-intersect="$el.classList.add('animate-slide-in-right')">
                    <div class="bg-white rounded-2xl p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
                        ...
                        <p class="text-gray-600 mb-8">Isi form di bawah ini untuk melaporkan dugaan pelanggaran</p>
