    ...
    <section class="py-16 bg-slate-50 min-h-[500px]" x-data="{ showPreview: false, previewUrl: '', previewTitle: '', isLoading: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($pembiayaanProducts->count() > 0)
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-slate-900 mb-6 text-center">Brosur Produk Pembiayaan</h2>
                            ...
                            <div class="bg-white rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
                                <div class="p-6">
                                    <div class="flex items-start justify-between mb-6">
                                        <div class="w-14 h-14 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl flex items-center justify-center text-emerald-500 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300 shadow-sm">
                                    ...
                                    <h3 class="text-xl font-bold text-slate-900 mb-2 line-clamp-2 group-hover:text-emerald-600 transition-colors" title="{{ $product->name }}">
                                        {{ $product->name }}
                                    </h3>
                                    ...
                                    <div class="flex gap-3">
                                        <a href="{{ route('brochures.download-product', $product) }}" class="flex-1 inline-flex items-center justify-center px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-sm font-semibold rounded-xl hover:shadow-lg hover:shadow-emerald-600/30 transition-all duration-300">
            ...
            @if($brochures->count() > 0)
                <div class="{{ $pembiayaanProducts->count() > 0 ? 'border-t border-slate-200 pt-12' : '' }}">
                    <h2 class="text-2xl font-bold text-slate-900 mb-6 text-center">Brosur Lainnya</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
