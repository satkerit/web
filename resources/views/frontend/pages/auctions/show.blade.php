                ...
                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                    <div class="flex-1">
                        <div class="flex flex-wrap items-center gap-3 mb-4">
                            ...
                            @endif
                            <span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-bold {{ $auction->status_color['bg'] }} {{ $auction->status_color['text'] }} shadow-lg">
                ...
                <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="relative aspect-[16/10] md:aspect-[16/9] bg-gray-100">
                            <template x-for="(image, index) in images" :key="index">
                                <img
                                    ...
                                    :src="'{{ \App\Helpers\StorageHelper::url('') }}' + image"
                                    :alt="'Foto ' + (index + 1)"
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div class="p-4 md:p-5 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl">
                                <p class="text-xs text-emerald-600 uppercase tracking-wide font-semibold mb-2">Kamar Tidur</p>
                                <p class="font-bold text-emerald-700 text-lg md:text-xl">{{ $auction->bedrooms }}</p>
                            </div>
                            @endif
                            @if($auction->bathrooms)
                            <div class="p-4 md:p-5 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl">
                                <p class="text-xs text-emerald-600 uppercase tracking-wide font-semibold mb-2">Kamar Mandi</p>
                            ...
                            <div class="p-4 md:p-5 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                                ...
                                <p class="font-bold text-blue-700 text-lg md:text-xl">{{ $auction->parking_spaces }} mobil</p>
                            </div>
                            @endif
                            @if($auction->year_built)
                            <div class="p-4 md:p-5 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl">
                                <p class="text-xs text-gray-500 uppercase tracking-wide font-semibold mb-2">Tahun Dibangun</p>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 md:p-6">
                            <p class="text-gray-700 text-base md:text-lg leading-relaxed">{{ $auction->full_address ?: $auction->city }}</p>
                            @if($auction->nearby_facilities)
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                <h4 class="font-semibold text-gray-900 mb-2">Fasilitas Terdekat:</h4>
                                <p class="text-gray-700 text-sm md:text-base">{!! nl2br(e($auction->nearby_facilities)) !!}</p>
                            </div>
                            @endif
                            @if($auction->transportation_access)
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                <h4 class="font-semibold text-gray-900 mb-2">Akses Transportasi:</h4>
                                <p class="text-gray-700 text-sm md:text-base">{!! nl2br(e($auction->transportation_access)) !!}</p>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
                        ...
                        <div class="prose prose-gray max-w-none text-gray-700 text-sm md:text-base bg-gray-50 rounded-xl p-4 md:p-6">{!! nl2br(e($auction->description)) !!}</div>
                    </div>
                    @endif
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
                        <h2 class="text-xl md:text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                            <span class="w-10 h-10 md:w-12 md:h-12 bg-red-100 rounded-xl flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-gray-50 rounded-xl p-4 md:p-5">
                                ...
                                <p class="text-gray-700 text-sm md:text-base">{!! nl2br(e($auction->legal_basis)) !!}</p>
                            </div>
                            @endif
                            ...
                            <div class="bg-gray-50 rounded-xl p-4 md:p-5">
                                ...
                                <p class="text-gray-600 text-xs mt-1">Tanggal: {{ $auction->court_decision_date->format('d F Y') }}</p>
                                @endif
                            </div>
                            @endif
                            ...
                            <div class="bg-red-50 rounded-xl p-4 md:p-5 md:col-span-2">
                                ...
                                <p class="text-red-700 text-lg md:text-xl font-bold">Rp {{ number_format($auction->debt_amount, 0, ',', '.') }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
                        ...
                        <div class="prose prose-gray prose-sm max-w-none text-gray-700 bg-yellow-50 rounded-xl p-4 md:p-6">{!! nl2br(e($auction->terms_conditions)) !!}</div>
                        @if($auction->special_conditions)
                        <div class="mt-4">
                            <h4 class="font-semibold text-gray-900 mb-2">Ketentuan Khusus</h4>
                            <div class="prose prose-gray prose-sm max-w-none text-gray-700 bg-orange-50 rounded-xl p-4 md:p-6">{!! nl2br(e($auction->special_conditions)) !!}</div>
                        </div>
                        @endif
                    </div>
                    @endif
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 lg:sticky lg:top-24 border border-gray-100">
                        ...
                        <div class="text-center mb-6 pb-6 border-b border-gray-100">
                            ...
                            <p class="text-3xl md:text-4xl font-bold text-emerald-600">{{ $auction->formatted_limit_price }}</p>
                        ...
                        <div class="space-y-4 md:space-y-5 mb-6 md:mb-8">
                            ...
                            <div class="flex items-start gap-3 md:gap-4">
                                <div class="w-9 h-9 md:w-10 md:h-10 bg-primary-100 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <svg class="w-4 h-4 md:w-5 md:h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"/></svg>
                                </div>
                                <div>
                        ...
                        <div class="bg-gradient-to-r from-orange-100 to-red-100 rounded-xl p-4 md:p-5 mb-6 border border-orange-200">
                            <p class="text-xs text-orange-700 font-bold uppercase tracking-wide mb-2">Waktu Tersisa</p>
                            <div class="text-center">
                                <p class="text-2xl md:text-3xl font-bold text-orange-700">{{ $auction->time_until_auction }}</p>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 md:p-5 mb-6 border border-gray-200">
                            ...
                            <div class="space-y-2">
                                ...
                                @endif
                                <p class="text-xl md:text-2xl font-mono font-bold text-gray-900 bg-white rounded-lg p-3 border">{{ $auction->account_number }}</p>
                        ...
                        <div class="border-t border-gray-100 pt-6 mb-6">
                            ...
                            <div class="space-y-2">
                                <p class="font-bold text-gray-900 text-base md:text-lg">{{ $auction->organizer_name }}</p>
                                ...
                                <a href="{{ $auction->organizer_website }}" target="_blank" class="inline-flex items-center text-primary-600 hover:text-primary-700 text-sm">
                        ...
                        <!-- Contact -->
                        @if($auction->contact_person || $auction->contact_phone || $auction->organizer_phone)
                        <div class="border-t border-gray-100 pt-6 mb-6">
                            ...
                            <div class="space-y-3">
                                ...
                                @php
                                    $phone = $auction->contact_phone ?: $auction->organizer_phone;
                                    $email = $auction->contact_email ?: $auction->organizer_email;
                                @endphp
                        ...
                        <!-- Status -->
                        @if($auction->status === 'sold')
                        <div class="text-center py-4 md:py-5 bg-emerald-100 rounded-xl text-emerald-700 font-bold text-sm md:text-base">
                        ...
                        <div class="text-center py-4 md:py-5 bg-green-100 rounded-xl text-green-700 font-bold text-sm md:text-base">
                            <span class="inline-block w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></span>
                            Pendaftaran Dibuka
                        </div>
                        @else
                        <div class="text-center py-4 md:py-5 bg-gray-100 rounded-xl text-gray-700 font-bold text-sm md:text-base">
                            {{ $auction->status_label }}
                        </div>
                        @endif
    ...
    <section class="py-12 md:py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 group">
                    <div class="relative aspect-[4/3] overflow-hidden">
                        ...
                        <div class="absolute top-3 right-3">
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $related->status_color['bg'] }} {{ $related->status_color['text'] }}">
    ...
    <div id="interest-modal" class="fixed inset-0 bg-gray-900 bg-opacity-50 backdrop-blur-sm overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border-0 w-full max-w-md shadow-2xl rounded-2xl bg-white">
            <div class="mt-3">
                ...
                <form id="interest-form" method="POST" action="{{ route('auctions.express-interest', $auction) }}" class="space-y-4">
                    @csrf
                    <div>
