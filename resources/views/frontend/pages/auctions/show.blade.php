...
@section('content')
    ...
    <section class="py-12 md:py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <!-- Header Info Card -->
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-6 md:p-8 mb-8 border border-gray-100 relative z-10 -mt-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    @if($auction->status === 'sold')
                        <div class="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-6 md:p-8 text-white shadow-xl">
                    ...
                    @if($auction->description)
                        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
                            ...
                            <div class="prose prose-emerald max-w-none text-gray-700 text-sm md:text-base bg-gray-50 rounded-xl p-4 md:p-6">
                    ...
                    <div class="lg:sticky lg:top-24 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100">
                            ...
                            @if($auction->auction_date && $auction->days_until_auction >= 0)
                                <div class="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 md:p-5 mb-6 border border-emerald-100">
                            ...
                            <div class="space-y-3">
                                <button onclick="showInterestModal({{ $auction->id }})"
                                   class="w-full py-4 bg-emerald-600 text-white font-bold text-center rounded-xl hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/30 transform hover:-translate-y-0.5 flex items-center justify-center gap-2 group">
