                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    <div class="mb-4 sm:mb-6">
                        <a href="{{ route('home') }}" class="inline-block transition-transform duration-300 hover:scale-105">
                            ...
                            @endphp
                            <img src="{{ Storage::url($company->logo_footer) }}" alt="{{ $company->name }}" class="{{ $logoClasses }}" style="opacity: {{ $opacity }};">
                            @elseif($company?->logo)
                            <img src="{{ Storage::url($company->logo) }}" alt="{{ $company->name }}" class="h-12 sm:h-14 lg:h-16 w-auto logo-no-bg">
                            @else
                    ...
                    <div class="flex space-x-2 sm:space-x-3">
                        @if($company?->facebook)
                        <a href="{{ $company->facebook }}" target="_blank" class="w-9 h-9 sm:w-10 sm:h-10 bg-white/10 hover:bg-emerald-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110">
                        ...
                        <a href="{{ $company->instagram }}" target="_blank" class="w-9 h-9 sm:w-10 sm:h-10 bg-white/10 hover:bg-emerald-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110">
                        ...
                        @endif
                        @if($company?->twitter)
                        <a href="{{ $company->twitter }}" target="_blank" class="w-9 h-9 sm:w-10 sm:h-10 bg-white/10 hover:bg-emerald-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110">
                        ...
                        @endif
                        @if($company?->youtube)
                        <a href="{{ $company->youtube }}" target="_blank" class="w-9 h-9 sm:w-10 sm:h-10 bg-white/10 hover:bg-emerald-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110">
