    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <a href="{{ route('home') }}" class="flex items-center space-x-3 group">
                @if($company?->logo)
                <img src="{{ \App\Helpers\StorageHelper::url($company->logo) }}" alt="{{ $company->name ?? 'Logo' }}" class="h-12 w-auto logo-no-bg group-hover:scale-105 transition-all duration-300">
                @else
