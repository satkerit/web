                ...
                <div class="lg:col-span-2 grid sm:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-gray-900 mb-2">Pembiayaan Syariah</h3>
                                <p class="text-gray-600 text-sm">Solusi pembiayaan sesuai prinsip syariah dengan proses mudah dan cepat</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-gray-900 mb-2">Simpanan Aman</h3>
                                <p class="text-gray-600 text-sm">Dana Anda dijamin LPS dan dikelola sesuai prinsip syariah</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-gray-900 mb-2">Layanan Profesional</h3>
                                <p class="text-gray-600 text-sm">Tim berpengalaman siap membantu kebutuhan finansial Anda</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">Pengajuan mudah dengan persetujuan yang cepat dan transparan</p>
                            </div>
                        </div>
                    </div>
                </div>
