                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form action="{{ route('admin.news.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn-delete p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="Hapus" data-title="Hapus Berita" data-text="Apakah Anda yakin ingin menghapus berita ini? Data yang dihapus tidak dapat dikembalikan.">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
