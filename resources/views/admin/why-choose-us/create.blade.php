...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h2 class="text-2xl font-bold text-slate-900 tracking-tight">Tambah Item Baru</h2>
            <p class="text-slate-500">Tambahkan poin keunggulan baru untuk ditampilkan.</p>
        </div>
    </div>
                ...
                <div class="space-y-4">
                     ...
                     <div x-data="{ preview: null }" class="border-2 border-dashed border-slate-200 rounded-2xl p-6 text-center hover:border-emerald-400 hover:bg-emerald-50/20 transition-all cursor-pointer relative group bg-slate-50/50">
                        ...
                        <div x-show="!preview" class="space-y-3">
                             ...
                             <div>
                                <p class="text-sm font-semibold text-slate-600">Upload Icon</p>
                                <p class="text-xs text-slate-500 mt-1">SVG, PNG, JPG, WebP</p>
                             </div>
                        </div>

                        <div x-show="preview" x-cloak class="relative">
                            <img :src="preview" class="h-32 mx-auto object-contain rounded-lg">
                            <button type="button" @click.prevent="preview = null; $el.closest('.relative').querySelector('input').value = ''" class="absolute -top-3 -right-3 bg-white text-red-500 border border-slate-100 rounded-full p-1.5 shadow-md hover:bg-red-50 transition-colors z-20">
                ...
                <div class="space-y-4">
                     ...
                     <div class="grid grid-cols-2 lg:grid-cols-3 gap-3">
                         ...
                         <label class="cursor-pointer group">
                             <input type="radio" name="color_theme" value="{{ $key }}" class="peer sr-only" {{ old('color_theme', 'primary') == $key ? 'checked' : '' }}>
