        ...
        <div class="space-y-6">
            <x-admin.card title="Mode Maintenance">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="maintenance_message" rows="3" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">{{ old('maintenance_message', $settings->maintenance_message) }}</textarea>
            ...
            <x-admin.card title="IP yang Diizinkan">
                <div>
                    ...
                    <textarea name="maintenance_allowed_ips" rows="4" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm font-mono" placeholder="192.168.1.1&#10;10.0.0.1">{{ old('maintenance_allowed_ips', $settings->maintenance_allowed_ips) }}</textarea>
