                ...
                <x-admin.card title="Driver Email">
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="mailer" id="mailer" class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm">
                ...
                <x-admin.card title="Konfigurasi SMTP" id="smtp-settings">
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="password" 
                                       ...
                                       class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm" 
                        ...
                        <div>
                            ...
                            <select name="encryption" class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm">
