...
@section('content')
<div class="space-y-6" x-data="backupManager({ createUrl: '{{ route('admin.database-backup.create') }}', cleanupUrl: '{{ route('admin.database-backup.cleanup') }}', restoreUrlTemplate: '{{ route('admin.database-backup.restore', ':filename') }}', deleteUrlTemplate: '{{ route('admin.database-backup.delete', ':filename') }}' })" x-init="init()">
    {{-- Header --}}
