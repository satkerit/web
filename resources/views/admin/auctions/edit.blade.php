                    ...
                    <form method="POST" action="{{ route('admin.auctions.update', $auction) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="address" id="address" rows="3" 
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('address', $auction->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $auction->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-6">
                            <label for="images" class="block text-sm font-medium text-gray-700">Gambar Baru</label>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="grid grid-cols-4 gap-4 mt-2">
                                        @foreach($auction->images as $image)
                                            <img src="{{ \App\Helpers\StorageHelper::url($image) }}" alt="Auction Image" class="w-full h-24 object-cover rounded">
                                        @endforeach
                                    </div>
                                </div>
                            @endif
