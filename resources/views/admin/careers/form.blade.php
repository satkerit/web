                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="employment_type" required class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" required class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6" placeholder="Jelaskan tentang posisi ini...">{{ old('description', $career->description ?? '') }}</textarea>
                    </div>
                </div>
            </x-admin.card>
            ...
            <x-admin.card title="Detail Lowongan">
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="requirements" rows="5" class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6" placeholder="- Pendidikan minimal S1&#10;- Pengalaman minimal 2 tahun&#10;- Menguasai Microsoft Office">{{ old('requirements', $career->requirements ?? '') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="responsibilities" rows="5" class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6" placeholder="- Mengelola akun media sosial&#10;- Membuat konten marketing&#10;- Menganalisis data penjualan">{{ old('responsibilities', $career->responsibilities ?? '') }}</textarea>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Benefit</label>
                        <textarea name="benefits" rows="4" class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6" placeholder="- BPJS Kesehatan & Ketenagakerjaan&#10;- Tunjangan makan&#10;- Bonus tahunan">{{ old('benefits', $career->benefits ?? '') }}</textarea>
                    </div>
                </div>
            </x-admin.card>
        </div>
