-- ========================================
-- SECURITY MONITORING - COMPLETE DEPLOYMENT SQL (FIXED)
-- ========================================
...
-- ========================================
-- FIXED: Menggunakan tabel 'role_permissions' (bukan 'permission_role')
-- ========================================
...
-- FIXED: Menggunakan tabel 'role_permissions'
INSERT IGNORE INTO
    role_permissions (
        role_id,
        permission_id,
